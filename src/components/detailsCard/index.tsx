...
const DetailsCard = ({ data }: { data: WorkspaceCardData }) => {
  return (
    <div className="lg:p-4 p-2 bg-white border-[1px] border-[#EEE7E7CC] rounded-lg shadow-[0px_1px_9px_0px_#0000000F] max-w-[400px]">
      ...
      <div className="grid grid-cols-2 gap-x-4">
        <div className="flex justify-between items-center bg-[#F9F9F9] border-[0.5px] border-[#EEE7E7] rounded-lg p-2 cursor-pointer">
          <div>
            ...
            <p className="text-primary heading-4 lg:text-[20px] text-[18px]">
              ₹ {data.day_pass_price}
